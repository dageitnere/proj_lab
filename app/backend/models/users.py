...
class User(Base):
    ...
    calculatedCarbs = Column(Float, nullable=True)
    calculatedProtein = Column(Float, nullable=True)
    calculatedFat = Column(Float, nullable=True)
    calculatedSatFat = Column(Float, nullable=True)
    calculatedSugar = Column(Float, nullable=True)
    calculatedSalt = Column(Float, nullable=True)
